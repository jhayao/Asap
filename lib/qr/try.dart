...
void main() => runApp(MaterialApp(home: QRTes()));

class QRTes extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _QRTesState();
}

class _QRTesState extends State<QRTes> {
  Barcode result;
