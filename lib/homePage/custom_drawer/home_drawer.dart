...
class _HomeDrawerState extends State<HomeDrawer> {
      ...
      content: Container(
        ...
        child: new Row(
          children: [
            ...
            Container(margin: EdgeInsets.only(left: 15),child:Text("Signing out" )),
          ],),
      )
    );
                          ...
                          child: Container(
                            ...
                            child: ClipRRect(
                              ...
                              // child: Image.asset('assets/images/userImage.png'),
                                child: Image.network(
                                  (_url != null ? _url : 'http://ssc.codes/storage/users/default.png'),
                                  fit: BoxFit.fill,
              ...
              ListTile(
                ...
                onTap: () async {
                  ...
                  Future.delayed(const Duration(seconds: 3),(){
                    Navigator.pushReplacement(context, PageRouteBuilder(pageBuilder: (context, anim1, anim2) => OnboardingPage()),
                    );
                  });
                      }
              ),
  ...
  void _getUserInfo() async{
      ...
      setState(() {
          userData = user;
          _url ='http://ssc.codes/storage/' +  ( userData!=null ? '${userData['avatar']}': '');
      });
  }
}
