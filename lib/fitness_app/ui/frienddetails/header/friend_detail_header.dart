...
import '../header/diagonally_cut_colored_image.dart';
import '../../friends/friend.dart';
import 'package:meta/meta.dart';

class FriendDetailHeader extends StatelessWidget {
  static const BACKGROUND_IMAGE = 'lib/resources/images/profile_header_background.png';
  ...
  Widget _buildAvatar() {
    return new Hero(
      ...
      child: new CircleAvatar(
        backgroundImage: new NetworkImage(friend.imagePath),
        radius: 50.0,
      ),
    );
  }
